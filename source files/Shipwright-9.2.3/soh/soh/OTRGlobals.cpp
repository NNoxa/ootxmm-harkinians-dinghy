...
extern "C" void VanillaItemTable_Init() {
    static GetItemEntry getItemTable[] = {
        ...
        GET_ITEM(ITEM_MASK_DEKU,        OBJECT_GI_SKJ_MASK,      GID_MASK_SKULL,       0x10, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR,           MOD_NONE, GI_MASK_SKULL),
        GET_ITEM(ITEM_MASK_FIERCE_DEITY, OBJECT_GI_TRUTH_MASK,   GID_MASK_TRUTH,       0x17, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR,           MOD_NONE, GI_MASK_TRUTH),
...
std::unordered_map<ItemID, GetItemID> ItemIDtoGetItemIDMap{
    ...
    { ITEM_MASK_DEKU, GI_MASK_SKULL },
    { ITEM_MASK_FIERCE_DEITY, GI_MASK_TRUTH },
...
extern "C" void Randomizer_ShowRandomizerMenu() {
    SohGui::ShowComboRandomizerSettingsMenu();
}
